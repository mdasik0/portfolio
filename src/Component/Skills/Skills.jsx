  ...
  return (
    ...
    >
      ...
      <div className="lg:w-1/2  w-full" >
          <img data-aos="zoom-in" data-aos-duration="1000" className="rounded" src="https://img.freepik.com/free-vector/hand-drawn-web-developers_23-2148819604.jpg?w=900&t=st=1688657788~exp=1688658388~hmac=67f85d6ccba32b891cd7282c24256c3d6f986fbe22cbf13f544560ba5a020164" alt="" />
        </div>
        <div className="lg:w-1/2 py-3 w-full ">
          <div  className="border-l-4 overflow-hidden pl-3 lg:mb-10 mb-3 border-[#fe6601]">
            <p data-aos="fade-right" data-aos-duration="1000" className="text-slate-500 mb-2">Web devlopment related</p>
            <h3 data-aos="fade-right" data-aos-duration="1000" className="text-3xl font-bold">Technical Skills</h3>
          </div>
