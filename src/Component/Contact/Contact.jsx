    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          Swal.fire("Error!", "An error has occured try again!", "error");
        }
      );
  };
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:mt-10 mt-5 lg:flex-row lg:gap-20 gap-6 items-center justify-center">
        ...
        <div className="flex lg:w-[max-content] w-full flex-col lg:gap-6 gap-3">
          <div className="border-2 bg-[#1b1b1b] hover:bg-transparent duration-300 w-full px-8 py-6 ">
          ...
          <div className="border-2 bg-[#1b1b1b] hover:bg-transparent duration-300 w-full px-10 py-6 ">
            <div className="mb-3 text-xl">
              <BsMessenger />
            </div>
