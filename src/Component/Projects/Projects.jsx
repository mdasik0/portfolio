    ...
    return (
        <section id="projects" className="lg:h-screen h-full mx-4 lg:max-w-[1300px] lg:mx-auto py-8">
            ...
            <div className="flex lg:flex-row my-4 flex-col gap-6 lg:gap-x-14">
                {/* card  */}
                <div className="border-[#fe6601] border-2 relative  duration-500 rounded bg-[#1a1919] h-[550px] lg:mt-10 w-full lg:w-[400px]">
                    {/* project img  */}
                ...
                {/* card end */}
                {/* card  */}
                <div className="border-[#fe6601] relative  border-2 duration-500 rounded bg-[#1a1919] h-[550px] lg:mt-10 w-full lg:w-[400px]">
                    {/* project img  */}
